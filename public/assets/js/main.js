...
document.addEventListener("DOMContentLoaded", (e) => {
	...
	switch (path) {
		...
		case "/gsc/backend/Views/pages/firstConnection.php":
		 ...
		 */
		case "/gsc/backend/Views/pages/place.php":
			selectYear();
			selectCycle();
			logoutUser();
		 ...
		 * Pages of personals
		 */
		case "/gsc/backend/Views/pages/personals/add-personal.php":
			userDropdownMenu();
			selectPlace();
			selectUserRole();
			logoutUser();
		...
		case "/gsc/backend/Views/pages/personals/edit-personal.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page de mise à jour d'un personnel");
			break;

		case "/gsc/backend/Views/pages/personals/list-personal.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 * Pages of professors
		 */
		case "/gsc/backend/Views/pages/teachers/add-teacher.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'un professeur");
			break;

		case "/gsc/backend/Views/pages/teachers/edit-teacher.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'un professeur");
			break;

		case "/gsc/backend/Views/pages/teachers/list-teacher.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 * Pages of parents
		 */
		case "/gsc/backend/Views/pages/parents/add-parent.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'un parent");
			break;

		case "/gsc/backend/Views/pages/parents/edit-parent.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'un parent");
			break;

		case "/gsc/backend/Views/pages/parents/list-parent.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 * Pages of students
		 */
		case "/gsc/backend/Views/pages/students/add-student.php":
			userDropdownMenu();
			selectPlace();
			selectLevel();
			selectSerie();
		...
		case "/gsc/backend/Views/pages/students/reinscription-student.php":
			userDropdownMenu();
			selectPlace();
			selectLevel();
			selectSerie();
		...
		case "/gsc/backend/Views/pages/students/edit-student.php":
			userDropdownMenu();
			selectPlace();
			selectLevel();
			selectSerie();
		...
		case "/gsc/backend/Views/pages/students/list-student.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 * Pages of schedules
		 */
		case "/gsc/backend/Views/pages/schedules/add-schedule.php":
			userDropdownMenu();
			selectTeacher();
			selectPlace();
			selectCourse();
		...
		case "/gsc/backend/Views/pages/schedules/edit-schedule.php":
			userDropdownMenu();
			selectTeacher();
			selectPlace();
			selectCourse();
		...
		case "/gsc/backend/Views/pages/schedules/list-schedule.php":
			userDropdownMenu();
			logoutUser();
		...
		case "/gsc/backend/Views/pages/schedules/timetable/timetable.php":
			console.log("Page de génération de l'emploi du temps");
			break;
		 ...
		 */
		case "/gsc/backend/Views/pages/scolarities/edit-scolarity.php":
			userDropdownMenu();
			logoutUser();
		...
		case "/gsc/backend/Views/pages/scolarities/list-scolarity.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 * Page profil
		 */
		case "/gsc/backend/Views/pages/profil.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-years/add-school-year.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'une année scolaire");
			break;

		case "/gsc/backend/Views/pages/settings/school-years/edit-school-year.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition de l'année scolaire");
			break;

		case "/gsc/backend/Views/pages/settings/school-years/list-school-year.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-places/add-school-place.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'un centre");
			break;

		case "/gsc/backend/Views/pages/settings/school-places/edit-school-place.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'un centre");
			break;

		case "/gsc/backend/Views/pages/settings/school-places/list-school-place.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-cycles/add-school-cycle.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'un cycle");
			break;

		case "/gsc/backend/Views/pages/settings/school-cycles/edit-school-cycle.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'un cycle");
			break;

		case "/gsc/backend/Views/pages/settings/school-cycles/list-school-cycle.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-grades/add-school-grade.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'une classe");
			break;

		case "/gsc/backend/Views/pages/settings/school-grades/edit-school-grade.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'une classe");
			break;

		case "/gsc/backend/Views/pages/settings/school-grades/list-school-grade.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-rooms/add-school-room.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'une salle");
			break;

		case "/gsc/backend/Views/pages/settings/school-rooms/edit-school-room.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'une salle");
			break;

		case "/gsc/backend/Views/pages/settings/school-rooms/list-school-room.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-series/add-school-serie.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'une série");
			break;

		case "/gsc/backend/Views/pages/settings/school-series/edit-school-serie.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'une série");
			break;

		case "/gsc/backend/Views/pages/settings/school-series/list-school-serie.php":
			userDropdownMenu();
			logoutUser();
		...
		case "/gsc/backend/Views/pages/settings/school-courses/edit-school-course.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'une matière");
			break;

		case "/gsc/backend/Views/pages/settings/school-courses/list-school-course.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-roles/add-school-role.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'un rôle");
			break;

		case "/gsc/backend/Views/pages/settings/school-roles/edit-school-role.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'un rôle");
			break;

		case "/gsc/backend/Views/pages/settings/school-roles/list-school-role.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-access/add-school-access.php":
			userDropdownMenu();
			selectUserRole();
			logoutUser();
		...
		case "/gsc/backend/Views/pages/settings/school-access/edit-school-access.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'un droit");
			break;

		case "/gsc/backend/Views/pages/settings/school-access/list-school-access.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-schooling/add-schooling.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'ajout d'un type de scolarité");
			break;

		case "/gsc/backend/Views/pages/settings/school-schooling/edit-schooling.php":
			userDropdownMenu();
			logoutUser();
			console.log("Page d'édition d'un type de scolarité");
			break;

		case "/gsc/backend/Views/pages/settings/school-schooling/list-schooling.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/settings/school-fees/add-fee.php":
			userDropdownMenu();
			selectSchooing();
			selectLevel();
			logoutUser();
		...
		case "/gsc/backend/Views/pages/settings/school-fees/list-fee.php":
			userDropdownMenu();
			logoutUser();
		 ...
		 */
		case "/gsc/backend/Views/pages/dashboard.php":
			userDropdownMenu();
			logoutUser();
