...
?>
	...
	<div class="main-panel">
		...
		<div class="main__header">
			<h2 class="list__title">Liste des droits d'accès</h2>
			<a href="add-school-access.php" class="btn__add" title="Ajouter un droit">+</a>
		</div>
			...
			<table class="list">
				<thead class="list__header">
					<tr class="list__row">
						...
						<th class="list__row-item">Droits d'Accès</th>
						<th class="list__row-item">Rôles Associés</th>
