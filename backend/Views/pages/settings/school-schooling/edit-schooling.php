	...
	<div class="main-panel">
		...
		<div class="form-container">
			...
			<div class="main__header">
				<h1 class="form__title">Modifier un type de scolarité</h1>
				<a href="list-schooling.php" class="btn__add" title="Liste des types de scolarités">&#8801;</a>
			</div>

			<form action="" method="POST" class="form__body" id="edit-schooling-form">

				<div class="form__group">
					<label for="schooling_id" class="group__label">type de scolarité : </label>
					<input type="hidden" name="schooling_id" placeholder="type de scolarité"
						id="schooling_id" class="group__input" required />
				</div>
