	...
	<div class="main-panel">
		<div class="form-container">
			...
			<div class="form__header">
				<h1 class="form__title">Modifier les informations d'un élève</h1>
			</div>

			<form method="POST" class="form__body" id="edit-student-form">

				<div class="form__group">
					<label for="user_id" class="group__label">ID : </label>
					<input type="text" name="user_id" id="user_id" placeholder="ID" class="group__input field-hidden" />
				</div>
