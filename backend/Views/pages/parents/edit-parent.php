	...
	<div class="main-panel">
		<div class="form-container">
			...
			<div class="form__header">
				<h1 class="form__title">Modifier les informations d'un parent</h1>
			</div>

			<form method="POST" class="form__body" id="edit-parent-form">

				<div class="form__group">
					<label for="user_id" class="group__label">ID : </label>
					<input type="text" name="user_id" placeholder="ID du parent" id="user_id"
						class="group__input field-hidden" required />
				</div>

				<div class="form__group">
					<label for="user_lastname" class="group__label">Nom du parent : </label>
					<input type="text" name="user_lastname" placeholder="Nom du parent" id="user_lastname"
						class="group__input" required />
				</div>

				<div class="form__group">
					<label for="user_firstname" class="group__label">Prénom du parent : </label>
					<input type="text" name="user_firstname" placeholder="Prénom du parent" id="user_firstname"
						class="group__input" required />
				</div>
