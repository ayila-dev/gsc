...
export const selectUserRole = function () {
	...
	const url = "/backend/Models/SelectRole.php";
...
export const selectCourse = function () {
	...
	const url = "/backend/Models/SelectCourse.php";
...
export const selectRoom = function () {
	...
	const url = "/backend/Models/SelectRoom.php";
...
export const selectTeacher = function () {
	...
	const url = "/backend/Models/SelectTeacher.php";
...
export const selectParent = function () {
	...
	const url = "/backend/Models/SelectParent.php";
...
export const selectSerie = function () {
	...
	const url = "/backend/Models/SelectSerie.php";
...
export const selectPlace = function () {
	...
	const url = "/backend/Models/SelectPlace.php";
...
export const selectYear = function () {
	...
	const url = "/backend/Models/SelectYear.php";
...
export const selectCycle = function () {
	...
	const url = "/backend/Models/SelectCycle.php";
...
export const selectSchooing = function () {
	...
	const url = "/backend/Models/SelectSchooling.php";
...
export const selectLevel = function () {
	...
	const url = "/backend/Models/SelectLevel.php";
...
export const logoutUser = () => {
	...
	logoutBtn.addEventListener("click", () => {
		if (window.confirm("Êtes-vous sûr de vouloir vous déconnecter ?")) {
			window.location.href = "/backend/Views/pages/logout.php";
