...
document.addEventListener("DOMContentLoaded", async (e) => {
	...
	switch (page) {
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href = `/backend/Views/pages/${result.redirect}`;
						}, 2000);
					} else {
						showPopup(
							"danger",
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/personals/list-personal.php";
						}, 2000);
		...
		case "edit-personal": {
			...
			try {
				const resPlaces = await fetch(
					"/backend/Models/SelectPlace.php"
				);
			...
			let roles = [];
			try {
				const resRoles = await fetch("/backend/Models/SelectRole.php");
			...
			try {
				const res = await fetch(
					`/backend/Models/Personal.php?action=get&id=${id}`
				);
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/teachers/list-teacher.php";
						}, 2000);
						// Ajout gestion du bouton copier
						setTimeout(() => {
							const btn =
		...
		case "edit-teacher": {
			...
			try {
				const res = await fetch(
					`/backend/Models/Teacher.php?action=get&id=${id}`
				);
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/parents/list-parent.php";
						}, 2000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/students/list-student.php";
						}, 2000);
					} else {
						showPopup(
							"danger",
			...
			try {
				...
				try {
					const resParents = await fetch(
						"/backend/Models/SelectParent.php"
					);
				...
				try {
					const resLevels = await fetch(
						"/backend/Models/SelectLevel.php"
					);
				...
				try {
					const resSeries = await fetch(
						"/backend/Models/SelectSerie.php"
					);
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/schedules/list-schedule.php";
						}, 2000);
					} else {
						showPopup(
							"danger",
		...
		case "edit-schedule": {
			...
			try {
				const resCourses = await fetch(
					"/backend/Models/SelectCourse.php"
				);
			...
			let rooms = [];
			try {
				const resRooms = await fetch("/backend/Models/SelectRoom.php");
				rooms = await resRooms.json();
				const selectRoom = form.querySelector("[name='room_id']");
				selectRoom.innerHTML = "<option disabled>Salle</option>";
				rooms.forEach((room) => {
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/schedules/timetable/timetable.php";
						}, 2000);
					} else {
						showPopup(
							"danger",
			...
			if (page === "timetable") {
				...
				try {
					...
					document.addEventListener("click", async (e) => {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/schedules/timetable/generate-timetable.php";
						}, 1000);
					});
				} catch (err) {
					console.error(err);
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-years/list-school-year.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-places/list-school-place.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-cycles/list-school-cycle.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-grades/list-school-grade.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-rooms/list-school-room.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-series/list-school-serie.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-schooling/list-schooling.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-courses/list-school-course.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-roles/list-school-role.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-access/list-school-access.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
					...
					if (result.success) {
						...
						try {
							...
							if (!fresh || !fresh.success) {
								...
								window.location.href = `/backend/Views/pages/scolarities/invoice/invoice.php?${qs.toString()}`;
								return;
							}
							...
							window.location.href = `/backend/Views/pages/scolarities/invoice/invoice.php?${qs2.toString()}`;
						} catch (err) {
							console.error(
							...
							window.location.href = `/backend/Views/pages/scolarities/invoice/invoice.php?${tryQs.toString()}`;
						}
					} else {
						showPopup("danger", result.message);
					}
			...
			form.addEventListener("submit", async (e) => {
				...
				try {
					...
					if (result.success) {
						...
						setTimeout(() => {
							window.location.href =
								"/backend/Views/pages/settings/school-fees/list-fee.php";
						}, 3000);
					} else {
						showPopup(
							"danger",
		...
		case "edit-fee": {
			...
			try {
				const resSchoolings = await fetch(
					"/backend/Models/SelectSchooling.php"
				);
