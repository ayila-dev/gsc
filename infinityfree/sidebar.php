<?php
     ...
     header("Location: /backend/Views/pages/login.php");
     exit;
     }
?>
                    ...
                    <nav class="navigation-item__subnavigation subnavigation">
                         <?php if (hasAccess('add-personal')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/personals/add-personal.php">
                         ...
                         <?php if (hasAccess('list-personal')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/personals/list-personal.php">
               ...
               <li class="navigation__navigation-item navigation-item">
                    ...
                    <nav class="navigation-item__subnavigation subnavigation">
                         <?php if (hasAccess('add-teacher')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/teachers/add-teacher.php">
                         ...
                         <?php if (hasAccess('list-teacher')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/teachers/list-teacher.php">
               ...
               <li class="navigation__navigation-item navigation-item">
                    ...
                    <nav class="navigation-item__subnavigation subnavigation">
                         <?php if (hasAccess('add-parent')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/parents/add-parent.php">
                                   Ajouter un parent
                              </a>
                         <?php endif; ?>
                         ...
                         <?php if (hasAccess('list-parent')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/parents/list-parent.php">
                                   Liste des parents
                              </a>
                         <?php endif; ?>
                    </nav>
               ...
               <li class="navigation__navigation-item navigation-item">
                    ...
                    <nav class="navigation-item__subnavigation subnavigation">
                         <?php if (hasAccess('add-student')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/students/add-student.php">
                                   Inscrire un élève
                              </a>
                         <?php endif; ?>
                         ...
                         <?php if (hasAccess('reinscription-student')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/students/reinscription-student.php">
                                   Réinscrire un élève
                              </a>
                         <?php endif; ?>
                         ...
                         <?php if (hasAccess('list-student')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/students/list-student.php">
                                   Liste des élèves
                              </a>
                         <?php endif; ?>
                    </nav>
               ...
               <li class="navigation__navigation-item navigation-item">
                    ...
                    <nav class="navigation-item__subnavigation subnavigation">
                         <?php if (hasAccess('add-schedule')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/schedules/add-schedule.php">
                         ...
                         <?php if (hasAccess('list-schedule')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/schedules/list-schedule.php">
                         ...
                         <?php if (hasAccess('generate-timetable')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/schedules/timetable/generate-timetable.php">
               ...
               <li class="navigation__navigation-item navigation-item">
                    ...
                    <nav class="navigation-item__subnavigation subnavigation">
                         <?php if (hasAccess('list-scolarity')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/scolarities/list-scolarity.php">
               ...
               <li class="navigation__navigation-item navigation-item">
                    ...
                    <nav class="navigation-item__subnavigation subnavigation">
                         <?php if (hasAccess('order-grade')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/grades/order-grade.php">
                                   Ajouter des notes
                              </a>
                         <?php endif; ?>
                         ...
                         <?php if (hasAccess('edit-list-grade')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/grades/edit-list-grade.php">
                         ...
                         <?php if (hasAccess('generate-report-card')): ?>
                              <a class="subnavigation__subnavigation-item subnavigation-item"
                                   href="/backend/Views/pages/grades/report-card/generate-report-card.php">
